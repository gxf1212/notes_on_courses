...
\begin{enumerate}
	...
	分配比/容量因子$k$：一定$T$、$p$，两相达平衡后，组分在固定相质量（$p$）和流动相质量（$q$）的比值。
	\begin{equation*}
		k=\dfrac{p}{q}
	\end{equation*}
	...
	\begin{equation*}
		K=\dfrac{C_s}{C_m} =\dfrac{p/ V_s}{q/ V_M}=k \dfrac{V_0}{V_s}=k\beta
	\end{equation*}
...
\subsection{塔板理论（Theory of Plates）}
\begin{itemize}
...
\begin{enumerate}
	...
	\begin{definition*}{担体}{}
		担体是一种多孔的、化学惰性的固体颗粒，可以提供较大表面积的惰性表面以\heiti{承担固定液}。
	\end{definition*}
	\item 控温系统：控制恒温或程序升温。
