...
\begin{enumerate}
	...
	$K$与$k$的关系%\footnote{注意：是同一组分，所以才有$c\propto p/V$}：
	\begin{equation*}
...
小结：影响色谱柱效率的是理论塔板数$n$，$n$越大，色谱峰越窄，分离效率越好。从理论上可以通过该方程预测具有不同分配系数$K$的两种物质在塔板数为$n$的色谱柱上分离的情况。其中色谱分离不限于液-固相，也可是气-液相。
